...
public interface BookDao  {
    ...
    //增加数据
    @Insert("insert into book (name,money,chubanshe,zuozhe,uid,bid) values (${name},${money},${chubanshe},${zuozhe},${uid},${bid}) ")
    ...
    //更新书籍
    @Update("update book set name='${name}',money='${money}',chubanshe='${chubanshe}',zuozhe='${zuozhe}',uid='${uid}' where bid=${bid};")
